...
output leans toward $v_2=10$: its contribution ($0.3\times10=3.0$) is the largest of the three,
even though $v_1$ carries the biggest weight ($0.5\times4=2.0$) --- that's all attention is:
blend the values, weighing each by its attention weight.}
