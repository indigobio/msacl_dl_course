...
{\normalsize The neuron, activation functions, and a layer as a matrix}
\end{center}
...
% =========================== Q1 ===========================
\textbf{1. Name that activation.}\; {\small Write the correct name under each curve, using the
word bank.}
...
\vspace{1pt}
\begin{center}
{\small \textbf{Word bank:}\;\; ReLU \;$\cdot$\; Sigmoid \;$\cdot$\; Linear (no activation)}
\end{center}

\keybox{(a) Sigmoid, (b) ReLU, (c) Linear. The sigmoid is the S-curve squashing every input
into $(0,1)$; ReLU is flat at zero for negatives then rises with slope $1$, i.e.\ $\max(0,z)$;
a straight diagonal through the origin applies no nonlinearity at all.}
