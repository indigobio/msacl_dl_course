...
\vspace{2pt}
\textbf{(a)} recall (sensitivity) $=\ \dfrac{16}{16+4} =\ $ \rb{$16/20 = 0.80$ \,(80\%)}{3.4cm}
\work{0.3cm}

\textbf{(b)} specificity $=\ \dfrac{448}{448+32} =\ $ \rb{$448/480 = 0.93$ \,(93\%)}{3.4cm}
\work{0.3cm}

\textbf{(c)} precision $=\ \dfrac{16}{16+32} =\ $ \rb{$16/48 = 0.33$ \,(33\%)}{3.4cm}
\work{0.3cm}
...
\vspace{2pt}
\textbf{(a)} Many mislabeled and junk runs contaminate the training set. $\rightarrow$\ \rb{curation}{5cm}
\work{0.25cm}
...
\keybox{(a) \textbf{curation} --- clean the labels before anything fancier. (b) \textbf{class weights / SMOTE /
