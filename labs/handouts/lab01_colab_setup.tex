...
\vspace{3pt}
\begin{center}\includegraphics[width=0.50\textwidth]{img/colab_step2_savecopy.png}\end{center}
...
\vspace{3pt}
\begin{center}\includegraphics[width=0.54\textwidth]{img/colab_step3_runtime.png}\end{center}
