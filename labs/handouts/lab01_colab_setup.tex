...
{\footnotesize\texttt{https://colab.research.google.com/github/indigobio/msacl\_dl\_course/}\\
\texttt{\phantom{https://}blob/main/student\_pack/labs/lab01\_training\_loop.ipynb}}
...
\vspace{3pt}
\begin{center}\includegraphics[width=0.62\textwidth]{img/colab_step2_savecopy.png}\end{center}
...
\begin{itemize}
  ...
  \item The very first run installs things and fetches the data --- give it a few seconds.
...
\vspace{3pt}
\begin{center}\includegraphics[width=0.66\textwidth]{img/colab_step3_runtime.png}\end{center}
...
Go to \texttt{colab.research.google.com} directly, sign in \mk[amber]{1}, then use
...
the text is still the one to follow.}
